...
searchstr = request.form("searchcol")
if searchstr="" then searchstr = request.querystring("searchcol")
...
<!-- #include file = "../inc/chead.inc" -->
          ...
          <td width="491" valign="top">
            <form method="POST" action="searchcol.asp">
            ...
            <p class="menub">
            [<a href="../bms/searchbm.asp"><font color="#3333FF">Want to search inside your Bookmarks? Click
            here!</font></a>]
            <p>

              <span class="menub"> &nbsp;ENTER SEARCH TERM</span><br>
              <input type="text" name="searchcol" class="register" size="30" value="<%= searchstr %>">
...
<%
			...
			sql = "SELECT publishid, person.name, publish.title, publish.User_id, publish.description,publish.anonymous FROM publish, person WHERE publish.Category_ID >0 AND publish.User_ID = person.personid and (publish.title like '%" & token & "%' or publish.description like '%" & token & "%')"
...
%>
              <tr>
                ...
                <td width="51" align="center"><a href="../tree/cview.asp?ref=SEARCH&amp;pid=<%= pid %>"><img src="../images/bsquare.gif" width="14" height="14" border="0" alt="View"></a></td>
                ...
                <td width="58" align="center"><a href="invite.asp?ref=SEARCH&amp;pid=<%= pid %>"><img src="../images/ysquare.gif" width="14" height="14" border="0" alt="Invite"></a></td>
              </tr>
<%
	rs.movenext
	if not rs.eof then
