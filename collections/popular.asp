...
<%
			...
			sql = "SELECT top 20 publishid, person.name, publish.title, publish.User_id, publish.description,publish.anonymous ,(SELECT COUNT(*) FROM subscriptions WHERE publish_id=publishid) AS pcount FROM publish, person WHERE publish.Category_ID >0 AND publish.User_ID = person.personid order by pcount desc"
...
%>
              <tr>
                ...
                <td width="51" align="center"><a href="../tree/cview.asp?ref=POPULAR&amp;pid=<%= pid %>"><img src="../images/bsquare.gif" width="14" height="14" border="0" alt="View"></a></td>
                ...
                <td width="58" align="center"><a href="invite.asp?ref=POPULAR&amp;pid=<%= pid %>"><img src="../images/ysquare.gif" width="14" height="14" border="0" alt="Invite"></a></td>
              </tr>
<%
	rs.movenext
	if not rs.eof then
